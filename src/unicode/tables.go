// 此处代码是在 golang.org/x/text 下运行 go generate 生成，DO NOT EDIT。

package unicode

// Version 是 Unicode 版本，tables 据此生成。
const Version = "12.0.0"

// Categories 是 Unicode 类型表的集合。
...
// Scripts 是 Unicode script tables 集合。
...
// Properties 是 Unicode property tables 的集合。
...
// CaseRanges 是描述不具有自身映射的所有字母大小写映射表。
...
// FoldCategory 将类名称映射到该类外的码点表，这些码点在简单大小写折叠下等效于该类的码点。
// 如果没有类名称条目，则没有这些码点。
...
// FoldScript 将 script 名称映射到该 script 外的码点表，这些码点在简单大小写折叠下等效于该  script 内的的码点。
// 如果没有 script 名称条目，则没有这些码点。
